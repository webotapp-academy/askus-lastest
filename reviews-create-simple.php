...
try {
    ...
    // Find an existing order for this user and vendor, or use the first available order
    ...
    $finalOrderId = $existingOrder ? $existingOrder['id'] : 1; // Use existing order or fallback to order ID 1
