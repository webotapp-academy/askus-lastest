...
error_log("📋 Payment record found: ID=" . $payment['id'] . ", Status=" . $payment['status'] . ", User ID=" . $payment['user_id']);

// Check if authentication is required
// If user_id is 0, it's a registration payment - NO auth required
...
try {
    ...
    error_log("✅ Payment record updated to success");
